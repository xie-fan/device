...
设备身份走配置树（环境 → 厂商 → 设备类型，`/registry`，落盘 `configs/registry.yaml`）：厂商/类型有名称与简称，wire 值与环境 url 占位符都用简称。**Phase 11 起挂靠在 start 时给**，不再写进设备定义（phase11.md；phase2.md §6.10 的创建体形状已过时）。Phase 1 CLI 仍用单机平铺 YAML。
...
3. `phase4.md`、`phase5.md`、`phase6.md`、`phase7.md`、`phase8.md`、`phase9.md`、`phase10.md`、`phase11.md` 按需
